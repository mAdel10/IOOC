...
import com.ioocllcdrdapp.iooc.backend.operations.MoocPlatformOperation;
import com.ioocllcdrdapp.iooc.controllers.adapters.MoocAdapter;
...
public class MOOCsFragment extends Fragment implements RequestObserver {

    private RecyclerView recyclerView;
    private Context context;
    private final static int REQUEST_MOOCPLATFORM = 1;
    private View loadingView;

    public MOOCsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_moocs, container, false);
        context = Objects.requireNonNull(getActivity()).getApplicationContext();

        recyclerView = view.findViewById(R.id.recycler_view);
        loadingView = view.findViewById(R.id.moc_loading_view);
    ...
    public void getMoocPlatform() {
        MoocPlatformOperation operation = new MoocPlatformOperation(REQUEST_MOOCPLATFORM, false, context);
    ...
    public void handleRequestFinished(Object requestId, Throwable error, Object resultObject) {
        if (error != null) {
            ...
            if (requestId.equals(REQUEST_MOOCPLATFORM)) {
                List<MoocPlatform> moocPlatforms = (List<MoocPlatform>) resultObject;
                MoocAdapter moocAdapter = new MoocAdapter(moocPlatforms, context);
                recyclerView.setAdapter(moocAdapter);
            }
        }
